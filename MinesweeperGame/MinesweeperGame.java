...
public class MinesweeperGame {
	...
	public static void main(String[] args) {
		 ...
		 */
		int dimension, dimension2, mineNumber;
		Scanner scan = new Scanner(System.in);
		
		System.out.print("Please enter the dimensions of the game area(A x B) : ");
		dimension = scan.nextInt();
		dimension2 = scan.nextInt();
		
		
		int[][] game = new int[dimension][dimension2];
		String[][] mines = new String[dimension][dimension2];
		
		mineNumber = Math.round((dimension * dimension2) / 4);
		mines = Minesweeper.mines(mineNumber, mines, dimension, dimension2);
		
		Minesweeper.run(mines, dimension, dimension2, game, mineNumber);
